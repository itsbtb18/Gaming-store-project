...
public class ProfilePage extends JPanel {
    ...
    private JPanel createHeaderPanel() {
        ...
        avatarPanel.setBackground(ColorScheme.MEDIUM_PURPLE);
        
        // Username
        JLabel usernameLabel = new JLabel("Username");
        usernameLabel.setFont(new Font("Segoe UI", Font.BOLD, 24));
        usernameLabel.setForeground(ColorScheme.TEXT_COLOR);
    ...
    private void addActivity(JPanel container, String activity, String time) {
        ...
        activityPanel.setBackground(ColorScheme.MEDIUM_PURPLE);
        activityPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 40));
        
        JLabel activityLabel = new JLabel(activity);
        activityLabel.setForeground(ColorScheme.TEXT_COLOR);
        
        JLabel timeLabel = new JLabel(time);
        timeLabel.setForeground(ColorScheme.TEXT_COLOR);
    ...
    public void mouseExited(MouseEvent e) {
        ...
        button.setBackground(ColorScheme.MEDIUM_PURPLE);
        animateButton(button, -5);
    }

    // Add missing Timer implementation
